    ...
    for tileY = 1, 8 do
        ...
        for tileX = 1, 8 do
            if self.level > 6 then
                self.variety = math.random(4,6)
            end
            table.insert(self.tiles[tileY], Tile(tileX,tileY, math.random(5), math.random(self.variety)))
